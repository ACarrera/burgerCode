...
<div className="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div className="modal-dialog">
    ...
    <input type="text" className="form-control p-1 m-0"  {...register("menu", { required: true })} required aria-describedby="emailHelp"/>
    <label className="form-label m-0 fs-6">Descripción</label>
    <input type="text" className="form-control p-1" {...register("description", { required: true })} required />
    <label className="form-label m-0 fs-6">Precio</label>
    <input type="number" className="form-control p-1" {...register("price", { required: true })} required />
