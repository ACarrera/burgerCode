   ...
   window.location.href  = "/"
    ...
    <>
      <div className="home-container">
        ...
        <p>Hemos elegido el tipo de pan que mejor le va a cada burger, el pan de hamburguesa con semillas de amapola o el artesano, pero puedes cambiarlo si lo deseas o sencillamente pedirla sin pan. También disponemos de pan sin gluten.</p> <hr />
        <h4 className="text-center pagina-text">DE LOS MEJORES INGREDIENTES</h4>
